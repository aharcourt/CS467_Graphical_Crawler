    ...
    let searchingPromise = new Promise((resolve, reject) => {
        ...
        function getRandomLink(url) {
            ...
            if (currentDepth >= searchDepth) {
               let treeInsert = dbAPI.insertNewTree(rootUrl, 'Ian Dalrymple', cookie, 'DFS', searchDepth);
            
                treeInsert.then((result) => {
                    console.log("INSERT NEW TREE RESULT: " + result);
                });
            ...
            helperPromise.then(() => {
                ...
                tempInsert.then((result) => {
                    console.log("INSERT INTO TEMP EDGES RESULT: " + result);
                });
