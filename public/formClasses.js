...
class SearchForm extends Form {
    constructor(options) {
        super(options);
        this._prevSearches = options.prevSearches;
...
class NameForm extends Form {
    ...
    _createForm() {
        ...
        // Name input field
        let nameField = this._createField();
        this.name = this._createElement("input", {
            type: "text",
            name: "name",
            id: "name",
            value: "",
        ...
        let nameLabel = this._createElement("label", {
            for: "name",
            textContent: "What's your name?"
        });
        nameField.appendChild(nameLabel);
        nameField.appendChild(this.name);
        this.formTag.appendChild(nameField);
